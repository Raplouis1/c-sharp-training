 ...
 •Method signature: 
  ...
  -Example: 
   ...
   -public void calculateGPA(float v1, float v2)
    ...
    -Despite of the arguments (float n1, float n2 / float v1, float v2) in the two methods having different names, their types(float) and 
     quantity(2 in the first method and 2 in the second method) are the same, making the signature in both methods the same.
